...
// User Menu Icons
const PersonIcon = ({ className, width = '1em', height = '1em' }) => {
    return (
        <SVGWrapper className={className} width={width} height={height}>
            <path
                fillRule='evenodd'
...
const CloseLargeIcon = ({ className, width = '18', height = '18' }) => {
    return (
        <SVGWrapper className={className} width={width} height={height} viewBox='0 0 9 10'>
